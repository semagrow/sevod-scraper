...
import eu.semagrow.scraper.cassandra.utils.CompactBNodeTurtleWriter;
import eu.semagrow.scraper.cassandra.utils.RdfMapper;
import eu.semagrow.scraper.cassandra.vocab.SEVOD;
import eu.semagrow.scraper.cassandra.vocab.VOID;
